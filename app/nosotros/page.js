              ...
              <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                <div className="content-box-modern">
                  ...
                  <p className="intro-text">
                    Somos expertos en la comercialización y producción de molduras, destacándonos por nuestra habilidad artística y artesanal. Ubicados en Zapopan, Jalisco, México.
                  </p>
                  ...
                  <div className="features-list">
                    <div className="feature-item">
                      ...
                      <div className="feature-content">
                        ...
                        <p>Poliestireno de alta densidad y fibra de vidrio para máxima durabilidad.</p>
                      </div>
                    </div>
                    ...
                    <div className="feature-item">
                      ...
                      <div className="feature-content">
                        <h4>Facilidad de Instalación</h4>
                    ...
                    <div className="feature-item">
                      ...
                      <div className="feature-content">
                        ...
                        <p>Desde clásicos hasta vanguardistas, molduras para cada gusto.</p>
                      </div>
                    </div>
                  </div>

                  <p className="closing-text">
                    Confíe en nuestra experiencia y compromiso con la excelencia artesanal para transformar sus espacios en lugares únicos y hermosos.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="auto-container">
            ...
            <div className="features-grid-modern">
              ...
              <div className="feature-card-modern wow fadeInUp animated" data-wow-delay="100ms" data-wow-duration="1000ms">
                ...
                <p>
                  Servicio personalizado y asesoramiento experto para garantizar la satisfacción total en cada proyecto.
                </p>
              </div>
              ...
              <div className="feature-card-modern wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1000ms">
                ...
                <p>
                  Productos de alta calidad a precios accesibles, permitiéndote embellecer tus espacios sin compromiso presupuestario.
                </p>
              </div>
              ...
              <div className="feature-card-modern wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1000ms">
                ...
                <p>
                  Molduras de instalación sencilla con instrucciones claras, ahorrando tiempo y esfuerzo en tus proyectos.
                </p>
              </div>
            </div>
          </div>
