...
export default function Layout({ headerStyle, footerStyle, headTitle, breadcrumbTitle, breadcrumbNameImage, children, wrapperCls }) {
    ...
    return (
        <>
            ...
            <div className={`boxed_wrapper ltr${wrapperCls ? wrapperCls : ""}`} id="#top">
                ...
                {breadcrumbTitle && <Breadcrumb breadcrumbTitle={breadcrumbTitle} breadcrumbNameImage={breadcrumbNameImage} />}
